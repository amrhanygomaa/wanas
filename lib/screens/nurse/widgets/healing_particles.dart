...
class _HealingParticlesState extends State<HealingParticles> with SingleTickerProviderStateMixin {
        ...
        builder: (context, child) {
          return Stack(
            children: List.generate(7, (index) {
              ...
              final progress = (_controller.value * speed + (index * 0.18)) % 1.0;
              ...
              return Positioned(
                ...
                child: Opacity(
                  ...
                  child: RotationTransition(
                    turns: AlwaysStoppedAnimation(progress * 0.5), // دوران خفيف جداً
                    child: Icon(
                      Icons.add_rounded,
