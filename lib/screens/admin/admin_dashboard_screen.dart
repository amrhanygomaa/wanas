...
import 'views/admin_settings_view.dart'; // واجهة إعدادات المنشأة (PUT)
...
class _AdminDashboardScreenState extends ConsumerState<AdminDashboardScreen>
  ...
  Widget _getCurrentView() {
    ...
    switch (_currentTabIndex) {
      ...
      case 7:
        return AdminSettingsView(fadeAnimations: _fadeAnimations);
      default:
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Expanded(
              child:
                  _buildNavItem(7, Icons.settings_outlined, 'الإعدادات')),
        ],
      ),
    );
  }
