...
class _EditProfileSheetState extends ConsumerState<EditProfileSheet> {
              ...
              child: Column(
                ...
                children: [
                  ...
                  _buildFileUploadTile(
                      'السيرة الذاتية (CV)',
                      profile.cvFileName,
                      () => _showDocumentUploadUnavailable()),
                  _buildFileUploadTile(
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(hasFile ? fileName : 'لم يتم الرفع بعد',
                    style: TextStyle(
                        fontSize: 11,
                        color:
  ...
  void _showDocumentUploadUnavailable() {
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('رفع الملفات يحتاج اختيار ملف حقيقي وربطه بخدمة S3'),
      ),
    );
  }
